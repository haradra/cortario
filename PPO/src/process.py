...
def evaluate(opt, global_model, num_states, num_actions):
    ...
    env = create_train_env(actions, retina_name=opt.retina_name, fix_x=opt.fix_x, fix_y=opt.fix_y, mp_wrapper=False, use_retina=opt.retina, foveation=opt.foveation)
