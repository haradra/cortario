...
def evaluate(opt, global_model, num_states, num_actions):
    ...
    env = create_train_env(actions, mp_wrapper=False, retina_name=opt.retina_name, fix_x=opt.fix_x, fix_y=opt.fix_y, use_retina=opt.retina)
    ...
    while True:
        ...
        if flag_get(info):
            ...
            torch.save(local_model.state_dict(),
                       "{}/ppo_super_mario_bros_{}_{}".format(opt.saved_path, curr_step, tot_step))
