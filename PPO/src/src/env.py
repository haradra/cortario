...
def create_train_env(actions, retina_name, fix_x, fix_y, output_path=None, mp_wrapper=True, save_video=False, use_retina=True):
...
class MultipleEnvironments:
    def __init__(self, world, stage, action_type, num_envs, retina_name, fix_x, fix_y, use_retina, output_path=None, save_video=False):
        ...
        self.envs = [create_train_env(actions, output_path=output_path, save_video=save_video, retina_name=retina_name, fix_x=fix_x, fix_y=fix_y, use_retina=use_retina) for _ in range(num_envs)]
